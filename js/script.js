/*Um Dicionario que em uma casa guarda as frases e em outra casa guarda os autores*/
const quotes = [
    {
  ...
  //Pega os documentos do html
  const quoteBtn = document.getElementById("quoteBtn");
  const quoteText = document.querySelector(".quote .text");
  const quoteAuthor = document.querySelector(".quote .author");
//Função usada para pegar aleatoriamente uma frase
  function getQuote() {     /*faz ser aleatorio*/ /*quantidade de elemento*/
